...
\begin{document}
		...
		\begin{centering}
			...
			\begin{minipage}{\linewidth} 
				\begin{tabbing}
					...
					Zweitgutachter: \quad \=Prof. Dr.-Ing. Stefan Tai\\
	...
	\tableofcontents
	\include{section/0-Acknowledgements}
	
	\newpage
	\pagenumbering{arabic}
	\include{section/1-Introduction}
	\include{section/2-RelatedWork}
    \include{section/3-Background}
    \include{section/4-Architecture}
	\include{section/5-Analysis}
	\include{section/6-Conclusion}
    \include{section/7-Future_Work}
