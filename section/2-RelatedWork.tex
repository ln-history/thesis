...
various projects (including \tech{ln-history}) that focus on \gls{p2p} network monitoring.

Early Bitcoin Core contributor \citeauthor{corallo_21ninja}, shows his research, 
which focuses on DNS seed metrics and reachable nodes, on this website\footnote{\url{https://21.ninja}}~\cite{corallo_21ninja}.
Additionally, researcher \citeauthor{lopp_satoshi_info} maintains the \term{statoshi} project\footnote{\url{https://statoshi.info}}, 
providing extensive network visualizations~\cite{lopp_satoshi_info}
...
and geo-location studies by \citeauthor{valko_geolocated_2025}~\cite{valko_geolocated_2025}. 
