...
three types of \term{gossip messages}: \code{channel\_announcement}, \code{node\_announcement} and \code{channel\_update}. 
...
\begin{itemize}
    ...
    \item \textbf{Open-Source Verifiability:} 
        ...
        is completely open-source\footnote{\url{https://github.com/ln-history}} and publicly accessible 
        via a website\footnote{\url{https://ln-history.info}}.
\end{itemize}
...
While it is common to refer to \enquote{the} Lightning Network, the protocol does not enforce a single, unified topology. 
The network can technically fracture into multiple isolated components. 
...
Furthermore, the protocol allows for the creation of \textit{private} (unannounced) channels. 
...
\begin{itemize}
    ...
    \item \textbf{Empirical Data Analysis} 
        ...
        Firstly, it analyses real-time metadata collected over 48 days (January to March 2026) 
